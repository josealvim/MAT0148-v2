...
%                    \end{lemma}
    ...
    \section{O Universo Construtível}
        ...
        \begin{lemma}{$\alpha < \beta \rar L_\alpha \subset L_\beta$}
            ...
            então existe fórmula e parâmetros em algum $L_\gamma$ menor que $\gamma<\alpha$ tais que $x = \SET{t \in L_\gamma:Sat(A,\varphi,f)}$. 
        ...
        \end{lemma}
        \begin{theorem}{$\ZF\vdash(\varphi\restriction L)\bim Sat(A,\varphi,f)$}
