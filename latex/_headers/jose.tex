...
%ENVIRONMENTS
    ...
    \renewenvironment{lemma*}{\begannewenv\nl\nl
        \textbf{\arabic{envcount}}) 
        {\sc Lema:}
    }{}

    \renewenvironment{lemma}[1]{\begannewenv\nl\nl
        \textbf{\arabic{envcount}}) 
        {\sc Lema:} \textbf{#1}.
        \addcontentsline{toc}{subsection}{Prp. #1}\\\ind
    }{}

    \renewenvironment{proposition}[1]{\begannewenv\nl\nl
        \textbf{\arabic{envcount}}) 
        {\sc Proposição:} \textbf{#1}.
        \addcontentsline{toc}{subsection}{Prp. #1}\\\ind
    }{}

    \renewenvironment{theorem}[1]{\begannewenv\nl\nl
        \textbf{\arabic{envcount}}) 
        {\sc Teorema:} \textbf{#1}.
        \addcontentsline{toc}{subsection}{Teo. #1}\\\ind
    }{}
